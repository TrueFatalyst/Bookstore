...
namespace Web.Areas.Identity.Pages.Account
{
    public class ConfirmEmailChangeModel : PageModel
    {
        ...
        public ConfirmEmailChangeModel(UserManager<ApplicationUser> userManager, SignInManager<ApplicationUser> signInManager, IStringLocalizer<ConfirmEmailChangeModel> localizer)
        {
        ...
        public async Task<IActionResult> OnGetAsync(string userId, string email, string code)
        {
            ...
            if (user == null)
            {
                return NotFound($"{_localizer["Unable to load user with ID"]} '{userId}'.");
            }
