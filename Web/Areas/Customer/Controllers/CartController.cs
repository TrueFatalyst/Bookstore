...
namespace Web.Areas.Customer.Controllers
{
    ...
    public class CartController : Controller
    {
        ...
        public IActionResult Summary()
        {
            ...
            ShoppingCartViewModel.OrderHeader.Name = ShoppingCartViewModel.OrderHeader.ApplicationUser.FirstName + " " + ShoppingCartViewModel.OrderHeader.ApplicationUser.LastName;
        ...
        public IActionResult SummaryPOST()
        {
            ...
            if (!ModelState.IsValid)
            {
                var errors = ModelState.Select(x => x.Value.Errors)
                          .Where(y => y.Count > 0)
                          .ToList();
                return RedirectToAction(nameof(Summary), ShoppingCartViewModel);
            }
