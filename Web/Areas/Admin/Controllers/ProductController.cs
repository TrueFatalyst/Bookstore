...
namespace Web.Areas.Admin.Controllers
{
    ...
    public class ProductController : Controller
    {
        ...
        public IActionResult Upsert(int? id)
        {
            ...
            ProductCategoryiesViewModel productViewModel = new()
            {
                Product = new Product() { IsPromotional = false},
        ...
        [HttpPost]
        public IActionResult Upsert(ProductCategoryiesViewModel productViewModel, IFormFile? file)
        {
